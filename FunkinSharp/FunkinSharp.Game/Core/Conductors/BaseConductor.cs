...
namespace FunkinSharp.Game.Core.Conductors
{
    ...
    // Base Class for all the Conductor Logic, can be extended to add more functionality 
    ...
    public class BaseConductor
    {
        ...
        ///     <para/>
        ///     Update this every frame based on the audio positioning using <see cref="BaseConductor"/>
        /// </summary>
        public double SongPosition;

        /// <summary>
        ///     The current value set by <see cref="BaseConductor"/> (forceBPM)
        ///     <para/>
        ...
        // this method is marked as virtual to be able to call base.Update and update the song position of the base conductor
        ...
        public virtual void Update(double songPos, bool applyOffsets = true)
        {
        ...
        public double GetTimeInSteps(double ms)
        {
            ...
            else
            {
                ...
                var lastStepLengthMs = SongConstants.SECS_PER_MIN / lastTimeChange.BPM * SongConstants.MS_PER_SEC / TimeSignatureNumerator;
                var resultFractionalStep = (ms - lastTimeChange.TimeStamp) / lastStepLengthMs;
